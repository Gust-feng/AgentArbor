...
当前产品架构事实源是 [ADR-0022-AgentArbor桌面通用Agent与双运行时架构](../ADR-0022-AgentArbor桌面通用Agent与双运行时架构.md)。[ADR-0018-AgentArbor原生概念树架构](../ADR-0018-AgentArbor原生概念树架构.md) 已被 ADR-0022 部分取代。
...
- 与 ADR-0022 或 `docs/开发指南/` 冲突时，以 ADR-0022 和开发指南为准。
