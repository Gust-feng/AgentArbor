...
export const BUILTIN_PROVIDER_PROTOCOL_PROFILES: readonly ProviderProtocolProfile[] = [
  ...
  },
  {
    ...
    recommendedProtocolKind: "anthropic_messages",
    supportedProtocolKinds: ["anthropic_messages"],
  ...
  },
  {
    ...
    label: "Google Gemini",
    providerKind: "gemini",
    recommendedProtocolKind: "gemini_generate_content",
    supportedProtocolKinds: ["gemini_generate_content"],
...
export const BUILTIN_MODEL_PROVIDER_PRESETS: readonly ModelProviderPreset[] = [
  ...
  },
  {
    ...
    label: "Google Gemini",
    vendor: "Google",
    description: "Google Gemini 原生 GenerateContent 接口，模型列表来自 /v1beta/models。",
    providerKind: "gemini",
    protocolKind: "gemini_generate_content",
    baseUrl: "https://generativelanguage.googleapis.com",
    modelsPath: "/v1beta/models",
    protocolProfileId: "gemini",
    supportedProtocolKinds: ["gemini_generate_content"],
