...
import { createToolDisplayNode } from "./tool-display-renderer.js";
import { collectPanelDom, createPanelState, EVENT_LABELS, STATUS_LABELS, STREAM_TYPES } from "./state.js";

const state = createPanelState();
const dom = collectPanelDom();
