...
test("work view transcript keeps one reasoning node and one deduplicated body across replay catch-up", () => {
...
test("work view transcript drops generic processing notes", () => {
  const nodes = transcriptNodesFromRunEvents([
    event({
