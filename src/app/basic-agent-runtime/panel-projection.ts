...
export type BasicAgentPanelRunStatus = "pending" | "running" | "completed" | "failed" | "cancelled" | "blocked";

export type BasicAgentPanelRunProjectionInput = {
  readonly runId: string;
  readonly conversationId?: string;
  readonly goal: string;
  readonly status: BasicAgentPanelRunStatus;
  readonly runMode: BasicAgentRun["runMode"];
  readonly createdAt: string;
  readonly updatedAt: string;
  readonly streamEvents: readonly BasicAgentPanelStreamEventProjectionInput[];
...
export type BasicAgentPanelStreamEventProjectionInput = {
...
export function projectPanelJobToBasicRun(job: BasicAgentPanelRunProjectionInput): BasicAgentRun {
  const status = basicStatusForPanelJob(job);
  return {
    runId: job.runId,
...
export function projectPanelStreamEventToRunEvent(event: BasicAgentPanelStreamEventProjectionInput): RunEvent {
  ...
  return {
    ...
    summary,
    status: basicStatusForPanelEvent(event),
...
function basicEventTitle(event: BasicAgentPanelStreamEventProjectionInput): string {
...
function basicStatusForPanelEvent(event: BasicAgentPanelStreamEventProjectionInput): AgentTaskStatus {
...
function basicStatusForPanelJob(job: BasicAgentPanelRunProjectionInput): AgentTaskStatus {
...
function basicRunTitle(job: BasicAgentPanelRunProjectionInput, status: AgentTaskStatus): string {
...
function basicRunCurrentStep(job: BasicAgentPanelRunProjectionInput): string | undefined {
...
function basicRefsFor(event: BasicAgentPanelStreamEventProjectionInput): readonly ObservationRef[] {
