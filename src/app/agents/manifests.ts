  ...
  return [
    {
      ...
      description: "Shapes the raw user goal into converged Plan material.",
      lifecycle: {
        status: "active",
        createdReason: "Required for the first deterministic Plan Package compatibility path.",
    ...
    },
    {
      ...
      description: "Consumes an approved Plan Package and creates the minimal execution plan, WorkflowIR, and TaskSpec.",
      lifecycle: {
        status: "active",
        createdReason: "Required for the first deterministic Aboveground execution plan.",
    ...
    },
    {
      ...
      capabilities: ["artifact.produce", "minimal.desktop_agent.write"],
...
export function createUndergroundAgentClusterManifests(): AgentManifest[] {
  return [
    ...
    undergroundClusterManifest({
      ...
      name: "Underground Plan Steward",
      description: "Packages approved or awaiting underground direction material as a Plan Package.",
