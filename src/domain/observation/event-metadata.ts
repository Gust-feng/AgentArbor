...
export const EVENT_OBSERVATION_METADATA = {
  ...
  "underground.exploration_planned": metadata({
    summary: "Underground Center planned bounded radial exploration.",
    scope: "underground",
    phase: "underground",
  ...
  "direction_handoff.requested": metadata({
    summary: "Direction Handoff Package was requested.",
    scope: "handoff",
    progressStatus: "in_progress",
    phase: "handoff",
  ...
  "direction_handoff.completed": metadata({
    summary: "Direction Handoff Package was completed.",
    scope: "handoff",
    phase: "handoff",
    stage: "direction_handoff_completed",
  }),
  "direction_handoff.revision_requested": metadata({
    summary: "Direction Handoff revision was requested.",
    scope: "handoff",
    progressStatus: "in_progress",
    phase: "handoff",
  ...
  "growth_plan.requested": metadata({
    summary: "Growth Plan was requested.",
    scope: "aboveground",
    progressStatus: "in_progress",
    phase: "aboveground",
  ...
  "growth_plan.completed": metadata({
    summary: "Aboveground Center completed the Growth Plan.",
    scope: "aboveground",
    phase: "aboveground",
    stage: "growth_plan_completed",
  }),
  "growth_plan.revision_requested": metadata({
    summary: "Growth Plan revision was requested.",
    scope: "aboveground",
    progressStatus: "in_progress",
    phase: "aboveground",
  ...
  "growth_plan.revised": metadata({
    summary: "Growth Plan was revised.",
    scope: "aboveground",
    phase: "aboveground",
